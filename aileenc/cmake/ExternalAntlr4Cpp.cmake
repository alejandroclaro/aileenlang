...
macro(antlr4cpp_process_grammar
  ...
  string(TOUPPER ${antlr4cpp_project_namespace} antlr4cpp_project_namespace_upper)
  ...
  add_custom_target("ANTLR4CPP_GENERATION_${antlr4cpp_project_namespace_upper}"
    COMMAND
    ${CMAKE_COMMAND} -E make_directory ${ANTLR4CPP_GENERATED_SRC_DIR}
    COMMAND
    "${Java_JAVA_EXECUTABLE}" -jar "${ANTLR4CPP_JAR_LOCATION}" -Werror -Dlanguage=Cpp -visitor -o "${ANTLR4CPP_GENERATED_SRC_DIR}/${antlr4cpp_project_namespace}" -package ${antlr4cpp_project_namespace} "${antlr4cpp_grammar_lexer}" "${antlr4cpp_grammar_parser}"
  ...
  foreach(generated_file ${generated_files})
    list(APPEND ANTLR4CPP_SRC_FILES_${antlr4cpp_project_namespace_upper} ${generated_file})
  ...
  set(ANTLR4CPP_INCLUDE_DIRS_${antlr4cpp_project_namespace_upper} ${ANTLR4CPP_GENERATED_SRC_DIR}/${antlr4cpp_project_namespace})
